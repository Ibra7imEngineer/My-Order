...
.analysis-controls-wrapper .analysis-control-btn {
    min-height: 48px;
    padding: 14px 24px;
    border-radius: 12px;
    font-weight: 700;
...
.analysis-controls-wrapper .analysis-control-btn:hover {
    transform: translateY(-2px);
}
...
/* ============================================================
   ADVANCED INSIGHTS MODAL - Dark Mode Professional UI
   ============================================================ */
#advancedInsightsOverlay {
    position: fixed;
    inset: 0;
...
#advancedInsightsOverlay.active {
    display: flex;
}
...
#advancedInsightsModal {
    ...
    box-shadow: 0 0 60px rgba(255, 107, 53, 0.4), 0 0 100px rgba(94, 87, 255, 0.2);
    padding: 0;
    animation: slideInCenter 0.5s cubic-bezier(0.4, 0, 0.2, 1);
    overflow: hidden;
}

#advancedInsightsOverlay.active #advancedInsightsModal {
    transform: translate(-50%, -50%) scale(1);
}

/* Modal Header */
.advanced-insights-header {
    background: linear-gradient(135deg, rgba(255, 107, 53, 0.15) 0%, rgba(94, 87, 255, 0.1) 100%);
    padding: 28px 32px;
...
.advanced-insights-content::-webkit-scrollbar {
    width: 8px;
}

.advanced-insights-content::-webkit-scrollbar-track {
    background: rgba(255, 107, 53, 0.05);
    border-radius: 10px;
}

.advanced-insights-content::-webkit-scrollbar-thumb {
    background: linear-gradient(135deg, #FF6B35, #FF8E5F);
    border-radius: 10px;
}
...
.insight-section::before {
    ...
    right: 0;
    height: 3px;
    background: linear-gradient(90deg, #FF6B35, #FFB347, #FF8E5F);
